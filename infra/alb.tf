############################################
# 0) 변수: ACM 인증서 (ap-northeast-3, ISSUED)
############################################
...
############################################
# 4) Listeners (80 → 443 리디렉션, 443 → TG 포워드)
############################################
...
# HTTPS 443 → Target Group (제공한 ACM 인증서 사용)
...
############################################
# 5) EC2 SG 최소권한(권장): 80은 ALB SG에서만 허용
############################################
